...
export default function PricingCard(props: any) {
  return <div className={`bg-white`}>
   ...
   <h3 className="fonts-bold text-lg mt-5">{props.title}</h3>
    ...
    <p>Downloads</p>
    <p className="text-xl font-bold">{props.price} INR/<small>month</small></p>

    <button className="px-5 py-2 border-2 border-black rounded-full mt-5 hover:bg-black hover:text-white">Subscribe now</button>
