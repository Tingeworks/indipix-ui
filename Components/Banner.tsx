    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          <img style={{ transition: "all 1s" }} className={`w-full h-full ${headerOpacity == 0 ? "opacity-0 -translate-y-full " : "translate-y-0 opacity-100"}`} src={`${CONFIG.ROOT_URL}${image}`} alt="" />
        </div>
      </div>
    </div>
  );
